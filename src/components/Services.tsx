  ...
  return (
    <section id="services" className="py-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* E-Commerce Search Empty State */}
        {filteredProducts.length === 0 && (
          <div className="bg-white/3 border border-white/8 rounded-[2rem] p-12 text-center max-w-md mx-auto">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-lg bg-[#05050c] border border-white/10 rounded-[2rem] overflow-hidden shadow-2xl z-10 flex flex-col p-6 max-h-[90vh] overflow-y-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-start">
              {/* Large Visual Frame */}
              <div className="aspect-square bg-gradient-to-tr from-blue-500/5 to-purple-600/5 border border-blue-500/15 rounded-2xl flex items-center justify-center text-4xl text-blue-400 relative">
                {getProductIcon(selectedQuickViewProduct.iconName)}
                <span className="absolute top-3 left-3 flex items-center gap-1 bg-black/50 backdrop-blur-md px-2 py-0.5 rounded-lg border border-white/10 font-mono text-[10px] text-white">
